...
<body>
	<form id="createform" name="createform"
		<c:if test="${pageNumber!=null}">action="${root}/fileboard/writeOk.do?pageNumber=${pageNumber}"</c:if> 
		<c:if test="${pageNumber==null}">action="${root}/fileboard/writeOk.do"</c:if> 
		method="post"
		...
		<div class="menu" style="border-bottom-width: 0px;">
			...
			<div id="id">작성자</div>
			<span> <input type="text" name="name" size="12">
			</span>
		</div>
		...
		<div class="menu" style="border-bottom-width: 0px;">
			...
			<span> <input type="text" name="subject" size="50">
			</span>
		</div>
		...
		<div class="menu" style="border-bottom-width: 0px;">
			...
			<span> <input type="email" name="email" size="50">
			</span>
		</div>
