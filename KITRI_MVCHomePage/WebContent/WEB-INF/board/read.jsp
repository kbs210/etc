...
<body>
	...
	<div id="createform">
		...
		<div class="menu" style="border-bottom-width: 3px; text-align: center">
			...
			<input type="button" value="답글" onclick="replyFunc('${root}','${boardDto.boardNumber}','${pageNumber}','${boardDto.groupNumber}','${boardDto.sequenceNumber}','${boardDto.sequenceLevel}')"/> <%-- url, 글번호, 그룹번호, 시퀀스번호, 시퀀스레벨--%>
