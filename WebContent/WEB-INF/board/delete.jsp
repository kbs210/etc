...
<body>
	<form id="createform" name="createform"
		action="${root}/board/deleteOk.do?pageNumber=${pageNumber}" method="post"
		...
		<div id="createform">
			...
			<div class="menu"
				...
				<input type="button" value="취소"
					onclick="location.href='${root}/board/read.do?boardNumber=${boardDto.boardNumber}&pageNumber=${pageNumber}'" />
			</div>
		</div>
	</form>
</body>
