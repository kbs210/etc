...
<body>
	...
	<% 
		...
		//내장객체 
		//pageScope : 현재 페이지에서만 데이터 공유(지역변수 개념)
		pageContext.setAttribute("pName", "apple");
		
		//requestScope : 요청시 데이터 공유(form, include, forward)
		request.setAttribute("rName", "samsung");
		
		//sessionScope : 하나의 웹 어플리케이션에서 웹브라우저가 종료되기 전까지
		session.setAttribute("gName", "google");
		
		//appicationScope " 하나의 웹어플리케이션에서 웹서버가 꺼질때까지
